...
class PHPGraphLib {
				...
				if ($this->bool_x_axis_values) {
					if ($data_set_num == $this->data_set_count - 1) {
						if ($this->bool_x_axis_values_vert) {
							...
							imagettftext($this->image, 10, -20, $textHorizPos, $textVertPos + 10, $this->x_axis_text_color, './DejaVuSansCondensed.ttf', $key);
						}
					}
				}
	...
	function generateTitle() {
		...
		imagettftext($this->image, 14, 0, $this->title_x , $this->title_y + 10, $this->title_color, './DejaVuSansCondensed.ttf', $this->title_text);
	}
