...
<html lang="en">
	...
	<body>
		...
		<script src="http://static.{config.domain}/js/jquery.dataTables.min.js"></script>
		<script src="http://static.{config.domain}/js/jquery.dataTables.bootstrap.js"></script>
		...
		<script src="http://static.{config.domain}/js/lists.js?t={=time()}"></script>
